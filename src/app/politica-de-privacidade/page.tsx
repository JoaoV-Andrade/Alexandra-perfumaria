    ...
    <>
      ...
      <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-10">
        ...
        <p className="mt-6 text-sm leading-relaxed text-muted-foreground">
          Esta página explica quais dados a Alexandra Perfumaria coleta de quem
          visita ou compra na loja, para que servem e com quem são
          compartilhados, em conformidade com a Lei Geral de Proteção de Dados
          (LGPD).
        </p>
        ...
        <Section title="Quais dados coletamos">
          ...
          <p>
            O carrinho de compras fica salvo apenas no seu próprio navegador
            (armazenamento local), e não é enviado aos nossos servidores até a
        ...
        <Section title="Para que usamos seus dados">
          <p>
            Usamos os dados exclusivamente para processar o pedido: calcular o
            frete, gerar a cobrança, entregar o produto no endereço informado e
            entrar em contato sobre o andamento da compra.
          </p>
        ...
        <Section title="Com quem compartilhamos">
          ...
          <p>
            ...
            diferentes da sua própria compra.
          </p>
        </Section>
        ...
        <Section title="Seus direitos">
          <p>
            ...
            exclusão dos seus dados, entrando em contato pelo WhatsApp da loja.
          </p>
        </Section>
